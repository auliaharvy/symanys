        ...
        <div class="row">
          ...
          <div class="animated fadeInLeft col-md-8">
            <div class="card card-info">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form class="form-horizontal" role="form" action="<?php echo base_url(); ?>dokumen/dokumen_save" method="post" enctype="multipart/form-data">
                ...
                <div class="card-body col-sm-12">
                  ...
                  <div class="form-group col-md-6">
                    ...
                    <input type="text" class="form-control tglcalendar" name="tanggal_dokumen" value="<?php echo $tanggal_dokumen; ?>" required>
                  </div>
                  <div class="form-group col-md-6">
                    <label>Jenis Dokumen</label>
                    <select class="form-control select2" name="id_jenis_dokumen" required>
                      <?php echo $combo_jenis_dokumen;  ?>
                    </select>
                  </div>
                  <div class="form-group col-md-6">
                    <label>Nomor Dokumen</label>
                    <input type="text" class="form-control" name="nomor_dokumen" value="<?php echo $nomor_dokumen; ?>" required>
                  </div>
                  <div class="form-group col-md-6">
                    <label>Nama Dokumen</label>
                    <input type="text" class="form-control" name="nama_dokumen" value="<?php echo $nama_dokumen; ?>" required>
                  </div>
                  <div class="form-group col-md-6">
                ...
                <div class="card-footer">
                  ...
                  <a class="btn btn-danger float-right" href="<?php echo base_url(); ?>dokumen"><i class="fa fa-undo"> </i> Kembali</a>
                </div>
                <!-- /.card-footer -->
              </form>
            </div>
