  ...
  <body class="skin-blue-light layout-top-nav">
    <div class="wrapper">
        ...
        <nav class="navbar navbar-static-top">
          <div class="container">
            <div class="navbar-header">
              <a href="<?php echo base_url(); ?>" class="navbar-brand"> <b><?php if(!empty($site_name)){ echo 'SMPIT Nurul Fikri'; } ?></b></a>
            </div>
      ...
      <footer class="main-footer no-print">
        ...
        <div class="container">
          <strong>&copy; 2021<?php if(!empty($site_name)){ echo 'SMPIT Nurul Fikri'; } ?> </strong>
        </div><!-- /.container -->
      </footer>
    </div><!-- ./wrapper -->
