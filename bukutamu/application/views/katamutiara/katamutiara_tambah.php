              ...
              <div class="row mb-2">
                  ...
                  <div class="col-sm-6">
                      <ol class="breadcrumb float-sm-right">
                          ...
                          <li class="breadcrumb-item"><a href="<?php echo base_url(); ?>katamutiara"><?php echo $judul; ?></a></li>
              ...
              <div class="row">
                  ...
                  <div class="animated fadeInLeft col-md-8">
                      <div class="card card-info">
                          ...
                          <!-- /.card-header -->
                          <!-- form start -->
                          <form class="form-horizontal" role="form" action="<?php echo base_url(); ?>katamutiara/katamutiara_save" method="post">
                              ...
                              <div class="card-body">
                                  <div class="form-group row">
                                      <label class="col-sm-3 col-form-label">Kata Mutiara</label>
                                      <div class="col-sm-12">
                                          <input type="hidden" name="tipe" value="<?php echo $tipe; ?>">
                                          <input type="hidden" name="id_katamutiara" value="<?php echo $id_katamutiara; ?>">
                                          <input type="text" class="form-control" name="kata" value="<?php echo $kata; ?>" required>
                                      </div>
                                  </div>
                                  ...
                                  <div class="form-group row">
                                      ...
                                      <div class="col-sm-12">
                                          <input type="text" class="form-control" name="penemu" value="<?php echo $penemu; ?>" required>
                                      </div>
                                  </div>
                              ...
                              <div class="card-footer">
                                  ...
                                  <a class="btn btn-danger float-right" href="<?php echo base_url(); ?>katamutiara"><i class="fa fa-undo"> </i> Kembali</a>
                              </div>
                              <!-- /.card-footer -->
                          </form>
                      </div>
