              ...
              <div class="row mb-2">
                  ...
                  <div class="col-sm-6">
                      <ol class="breadcrumb float-sm-right">
                          ...
                          <li class="breadcrumb-item"><a href="<?php echo base_url(); ?>agenda"><?php echo $judul; ?></a></li>
              ...
              <div class="row">
                  ...
                  <div class="animated fadeInLeft col-md-8">
                      <div class="card card-info">
                          ...
                          <!-- /.card-header -->
                          <!-- form start -->
                          <form class="form-horizontal" role="form" action="<?php echo base_url(); ?>agenda/agenda_save" method="post">
                              ...
                              <div class="card-body">
                                  <div class="form-group row">
                                      ...
                                      <div class="col-sm-12">
                                          ...
                                          <input type="text" class="form-control" name="nama_agenda" value="<?php echo $nama_agenda; ?>" required>
                                      </div>
                                  </div>

                                  <div class="form-group">
                                      <label>Tanggal Mulai</label>
                                      <input type="text" class="form-control tglcalendar" name="tanggal_mulai" value="<?php echo $tanggal_mulai; ?>" placeholder="Pilih Tanggal" required>
                                  </div>

                                  <div class="form-group">
                                      <label>Tanggal Selesai</label>
                                      <input type="text" class="form-control tglcalendar" name="tanggal_selesai" value="<?php echo $tanggal_selesai; ?>" placeholder="Pilih Tanggal" required>
                                  </div>
                              </div>
                              <!-- /.card-body -->
                              <div class="card-footer">
                                  <button type="submit" class="btn btn-info float-right ml-3"><i class="fa fa-save"> </i> Simpan</button>
                                  <a class="btn btn-danger float-right" href="<?php echo base_url(); ?>agenda"><i class="fa fa-undo"> </i> Kembali</a>
                              </div>
                              <!-- /.card-footer -->
                          </form>
                      </div>
