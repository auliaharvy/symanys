          ...
          <div class=" col-12">
            <div class="card card-info card-outline">
              <div class="card-header">
               <a class="btn btn-info btn-sm bg-navy" href="<?php echo base_url(); ?>pelanggaran_siswa/pelanggaran_siswa_tambah"><i class="fa fa-plus"> </i> Tambah Data</a>
              </div>
              <!-- /.card-header -->
                ...
                if(!empty($data['id_penginput'])) { 
                  ...
                  <tr>
                    ...
                    <td style="text-align:center;width:100px;">
                      ...
                      <a class="btn btn-info btn-xs" href="<?php echo base_url() . 'pelanggaran_siswa/pelanggaran_siswa_detail/' . $data['id_siswa']; ?>"><i class="fa fa-eye"> </i> </a>
                      <a class="btn bg-navy btn-xs" href="<?php echo base_url() . 'pelanggaran_siswa/pelanggaran_siswa_edit/' . $data['id_pelanggaran_siswa']; ?>"><i class="fa fa-edit"> </i> </a>
                      <a class="btn btn-danger btn-xs" href="<?php echo base_url() . 'pelanggaran_siswa/pelanggaran_siswa_hapus/' . $data['id_pelanggaran_siswa']; ?>" onclick="return confirm('Yakin ingin hapus data ?');"><i class="fa fa-trash"> </i> </a>
                    </div>
                    </td>
                  </tr>
                  <?php $no++;
