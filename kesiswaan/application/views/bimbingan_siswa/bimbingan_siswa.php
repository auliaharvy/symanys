          ...
          <div class=" col-12">
            <div class="card card-info card-outline">
              <div class="card-header">
               <a class="btn btn-info btn-sm bg-navy" href="<?php echo base_url(); ?>bimbingan_siswa/bimbingan_siswa_tambah"><i class="fa fa-plus"> </i> Tambah Data</a>
              </div>
              <!-- /.card-header -->
              <div class="card-body table-responsive p-2">
                ...
                if(!empty($data['id_penginput'])) { 
                  ...
                  <tr>
                    ...
                    <td class="text-sm"><?php echo $data['perihal']; ?></td>
                    <td class="text-sm"><?php echo date("d-m-Y", strtotime($data['tanggal'])); ?></td>
                    <td class="text-sm"><?php echo $nama_penginput; ?></td>
                    <td style="text-align:center;width:100px;">
                       <div class="btn-group btn-group-sm"> 
                      <a class="btn btn-info btn-xs" href="<?php echo base_url() . 'bimbingan_siswa/bimbingan_siswa_detail/' . $data['id_siswa']; ?>"><i class="fa fa-eye"> </i> </a>
                      <a class="btn bg-navy btn-xs" href="<?php echo base_url() . 'bimbingan_siswa/bimbingan_siswa_edit/' . $data['id_bimbingan_siswa']; ?>"><i class="fa fa-edit"> </i> </a>
                      <a class="btn btn-danger btn-xs" href="<?php echo base_url() . 'bimbingan_siswa/bimbingan_siswa_hapus/' . $data['id_bimbingan_siswa']; ?>" onclick="return confirm('Yakin ingin hapus data ?');"><i class="fa fa-trash"> </i> </a>
                    </div>
                    </td>
                  </tr>
                  <?php $no++;
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title text-info"><i class="far fa-upload"></i></i> Import Data Bimbingan Siswa</h4>
