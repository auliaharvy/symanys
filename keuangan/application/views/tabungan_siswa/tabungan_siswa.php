          ...
          <div class=" col-12">
            <div class="card card-info card-outline">
              <div class="card-header">
               <a class="btn btn-info btn-sm bg-navy" href="<?php echo base_url(); ?>tabungan_siswa/tabungan_siswa_tambah"><i class="fa fa-plus"> </i> Tambah Tabungan</a>
              ...
              <div class="card-body table-responsive p-2">
                ...
                if(!empty($data['id_penginput'])) { 
                  ...
                  <tr>
                    ...
                    <td class="text-sm" style="width:300px">Rp <?php echo number_format($data['saldo']); ?></td>
                    <td class="text-sm"><?php echo date("d-m-Y", strtotime($data['tanggal'])); ?></td>
                    <td class="text-sm"><?php echo $nama_penginput; ?></td>
                    <td style="text-align:center;width:100px;">
                       <div class="btn-group btn-group-sm"> 
                      <a class="btn btn-info btn-xs" href="<?php echo base_url() . 'tabungan_siswa/tabungan_siswa_detail/' . $data['id_siswa']; ?>"><i class="fa fa-eye"> </i> </a>
                      <a class="btn bg-navy btn-xs" href="<?php echo base_url() . 'tabungan_siswa/tabungan_siswa_edit/' . $data['id_tabungan_siswa']; ?>"><i class="fa fa-edit"> </i> </a>
                      <a class="btn btn-danger btn-xs" href="<?php echo base_url() . 'tabungan_siswa/tabungan_siswa_hapus/' . $data['id_tabungan_siswa']; ?>" onclick="return confirm('Yakin ingin hapus data ?');"><i class="fa fa-trash"> </i> </a>
                    </div>
                    </td>
                  </tr>
                  <?php $no++;
