          ...
          <div class=" col-md-12">
            <div class="card card-info card-outline">
              <div class="card-header col-md-12">
                ...
                <a><i class="fa fa-file-search text-info"> </i> Cari Data Belanja Berdasarkan</a>
                <form role="form" action="<?php echo base_url(); ?>laporan/proses_tampil_belanja" method="post">
                  <div class="row">
                    <div class="col-md-4">
              ...
              <img src="<?php echo 'http://'.$_SERVER['SERVER_NAME'].'/master/upload/'.$sekolah->logo; ?>" alt="Logo" class="brand-image img-rounded " style="width:60px;height:60px;">
               <br><?php echo $nama_sekolah ?></h4>
                      <h4 style="margin:0;">Laporan Belanja Siswa </h4>
                        ...
                        <tbody>
                          ...
                          ?>
                            <tr>
                              ...
                              <td class="text-sm" style="width:300px"><?php echo number_format($data['harga']); ?></td>
                            </tr>
                          <?php $no++;
                          } ?>
